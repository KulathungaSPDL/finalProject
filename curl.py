...
class CurlE(object):
    ...
    def __init__(self):
        ...
        #self.video = cv2.VideoCapture('Video/4.mp4')
            ...
            if len(lmList) != 0:
                ...
                if 160 < angle3 < 200:
                    ...
                    if 160 < angle5 < 200:
                        ...
                        per = np.interp(angle1, (60, 150), (0, 100))  # get presantage angle between 210 to 310
                        bar = np.interp(angle1, (60, 150), (100, 650))  # min & max
                        ...
                        if totalCount not in my_input:
                            ...
                            if (dalycount == totalCount):
                                ...
                                mxCount = totalCount
                                # print(mxCount)
                                sql = "INSERT INTO curl (count) VALUES (%s)"
                                val = mxCount
                                params = (val,)
